...
const SecondPage = ({ data }) => (
  <Layout>
    ...
    <main className={style.main}>
      ...
      >
        Call Susi at <a href='tel:2539617912'>253.961.7912</a> or email her at <a href='mailto:susi@hillcitystudio.com'>susi@hillcitystudio.com</a>.
      </p>
      <h3>
      ...
      <ul>
        <li>
          Session Payments of $420<br />
          (roughly $25 / lesson)
        </li>
        <li>
          Monthly Payments of $115<br />
          (roughly $28 / lesson)
        </li>
      </ul>
      ...
      <ul>
        <li>
          45 once-a-week private lessons
        </li>
        <li>
